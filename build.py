...
LANGS = {
    "zh": dict(
        ...
        prev_label="上一章",
        next_label="下一章",
        sidenote_html='全文免费在线阅读。另有排版好的中英双语 <a href="%s">PDF / EPUB 版本</a>，在 Gumroad 有售。',
    ...
    "en": dict(
        ...
        prev_label="Previous",
        next_label="Next",
        sidenote_html='Free to read online in full. A typeset <a href="%s">PDF + EPUB edition</a>, in English and Chinese, is also available on Gumroad.',
